...
const translations = {
  en: {
    ...
    'pending.heading':            'Registration received',
    'pending.body':               'Your account is under review. You will receive an email once the admin approves your access. This usually takes less than 24 hours.',
    'pending.rejected.heading':   'Registration not approved',
    'pending.rejected.body':      'Your registration was not approved. Please contact Leo directly for assistance.',
    'pending.email':              'Registered email',
    'pending.autoRefresh':        'This page checks for approval automatically every 60 seconds.',
  ...
  zh: {
    ...
    'auth.inviteCodePlaceholder': 'METIS-XXXX',
    'pending.heading':            '注册已收到',
    'pending.body':               '您的账户正在审核中。管理员批准后您将收到邮件通知，通常在24小时内完成。',
    'pending.rejected.heading':   '注册未被批准',
    'pending.rejected.body':      '您的注册申请未被批准。请直接联系 Leo 寻求帮助。',
    'pending.email':              '注册邮箱',
    'pending.autoRefresh':        '此页面每60秒自动检查审批状态。',
